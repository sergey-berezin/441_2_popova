...
public class Program
{
    public static void Main(string[] args)
    {
        ...
        int number_of_2x2 = 2;
        int number_of_3x3 = 2;
        int[] square_sizes = {1, 1, 1, 2, 2, 3, 3};
        int SQUARES = number_of_1x1 + number_of_2x2 + number_of_3x3;
        int LENGTH_CHROM = 2 * SQUARES;
        int POLE_SIZE = (int)Math.Sqrt(number_of_1x1 + number_of_2x2 * 4 + number_of_3x3 * 9) + 2;
        ...
        for (int generation = 0; generation < 1000; generation++)
        {
            ...
            foreach (Individual ind in offspring)
                ind.fitness = ind.CalculateFitness(square_sizes, POLE_SIZE);
